...
public class PhraseOMatic {
    public static void main(String[] args) {
        ...
        System.out.println("the length of word list one is " + oneLength);
        System.out.println("the length of word list two is " + twoLength);
        
        System.out.println(wordListOne[2] + " why is it a " + wordListOne[5]);
